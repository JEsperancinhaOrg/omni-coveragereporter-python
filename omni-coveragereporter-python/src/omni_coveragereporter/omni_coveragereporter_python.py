    ...
    for data_text in all_report_texts:
        ...
        if codecov_token is not None:
            ...
            if is_coverage_py(data_text):
                codecov_report = codecov_converter.convert_coverage_py(data_text, codecov_report)
        ...
        if coveralls_token is not None:
            ...
            if is_coverage_py(data_text):
                coveralls_report = coveralls_converter.convert_coverage_py(data_text, coveralls_report)
            elif is_coverage_go(data_text):
