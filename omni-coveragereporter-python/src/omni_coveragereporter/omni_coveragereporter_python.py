    ...
    for data_text in all_report_texts:
        ...
        if codecov_token is not None:
            ...
            if is_coverage_py(data_text):
                ...
                codecov_report = codecov_converter.convert_clover(data_text, codecov_report)
        else:
        ...
        if coveralls_token is not None:
            ...
            if is_coverage_py(data_text):
                ...
                coveralls_report = coveralls_converter.convert_clover(data_text, coveralls_report)
        else:
        ...
        if codacy_token is not None:
            ...
            if is_coverage_py(data_text):
                ...
                php_report = codacy_converter.convert_clover(data_text)
